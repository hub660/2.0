...
```
ql repo https://github.com/hub660/2.0.git "xixunyuna_cookie|xixunyunb_cookie|xixunyun_sign|xixunyun_sign_after|xixunyun_report" "" "^usr_.*|data/|sendNotify" "" "json|py" 
```
